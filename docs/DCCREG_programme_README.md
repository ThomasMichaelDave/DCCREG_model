...
| `DCCREG_emergent_matter_v03.md` | **Block V** — matter / fermion gate: screw-framing ⇒ ribbons; **spin-½** (belt trick / Finkelstein–Rubinstein); **automatic spin-statistics**; **spin = self-helicity, statistics = mutual helicity**; chirality ⇒ **Weyl**. Defect spectrum = the Block IV gravity coefficient | V-§ |
